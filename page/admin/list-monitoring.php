<h3 class="title">Monitoring Siswa</h3><hr>
...
?>
	...
	<td><?php echo "$dataDsn[id_prakerin]"; ?></td>
        ...
        <td>
            <a href="index.php?content=<?php echo 'monitoring-detail.php&id='.$dataDsn['id_prakerin']; ?>" class="btn btn-success" style="width: 100px">
              Detail</a>
