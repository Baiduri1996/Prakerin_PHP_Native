<h3 class="title">input nilai perusahaan</h3><hr>
...
?>
	...
	<td><?php echo "$dataDsn[id_prakerin]"; ?></td>
        ...
        <td>
            <a href="index.php?content=<?php echo 'nilai-perusahaan-input.php&id='.$dataDsn['id_prakerin']; ?>" class="btn btn-success" style="width: 80px">
              Input Nilai</a>
